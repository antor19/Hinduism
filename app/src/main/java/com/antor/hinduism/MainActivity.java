...
import static com.antor.hinduism.videolist.BUFFERING;
import static com.antor.hinduism.videolist.CUED;
import static com.antor.hinduism.videolist.ENDED;
import static com.antor.hinduism.videolist.PAUSED;
import static com.antor.hinduism.videolist.PLAYING;
import static com.antor.hinduism.videolist.UNSTARTED;
...
public class  MainActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    private void initMultiPlayers(){
        ...
        webYouTube = new videolist(MainActivity.this);
    ...
    private void setMasterJubaPlayerListener(){
        ...
        webYouTube.setCurrentTimeListener(new videolist.NumberReceivedListener() {
            @Override
            public void onReceive(float n) {
                currentSeconds = (int) n;
            }
        }); //TODO: Put this in player view itself
        webYouTube.setDurationListener(new videolist.NumberReceivedListener() {
            @Override
            public void onReceive(float n) {
                videoDuration = (int) n;
            }
        }); //TODO: Put this in player view itself
        webYouTube.setVideoLoadedFractionListener(new videolist.NumberReceivedListener() {
            @Override
            public void onReceive(float n) {
                videoBuffered = n;
            }
